...
const risks = [
  {
    id: 1,
    name: "Qualidade dos Modelos de IA",
    category: "Técnico",
    icon: Server,
    ...
    mitigation: [
      ...
      "Criar pipeline de fine-tuning com dados do cliente",
      "Monitoramento contínuo de acurácia com alertas",
    ],
    responsible: "Tech Lead",
  },
  {
    id: 2,
    name: "Segurança e Privacidade de Dados",
    category: "Compliance",
    icon: Lock,
    ...
    level: "Crítico",
    mitigation: [
      "Criptografia end-to-end e anonimização",
      "Compliance LGPD/GDPR desde o design",
  ...
  },
  {
    ...
    level: "Alto",
    mitigation: [
      "Programa de change management com treinamentos",
      "Demonstração clara de ROI com casos de sucesso",
      "Interface intuitiva com explicabilidade das decisões",
    ],
    responsible: "Product Manager",
  },
  {
    id: 4,
    name: "Escalabilidade Técnica",
    category: "Técnico",
    icon: TrendingDown,
    ...
    level: "Alto",
    mitigation: [
      "Arquitetura cloud-native com auto-scaling",
      "Processamento assíncrono em filas",
      "Testes de carga regulares (stress testing)",
    ],
    responsible: "DevOps Lead",
  },
  {
    id: 5,
    name: "Dependência de APIs Externas",
    category: "Técnico",
    icon: AlertTriangle,
    ...
    level: "Médio",
    mitigation: [
      "Arquitetura multi-provider com fallback",
      "Cache de respostas para operações críticas",
      "Monitoramento de SLAs dos fornecedores",
    ],
    responsible: "Tech Lead",
  },
  {
    id: 6,
    name: "Competição de Mercado",
    category: "Mercado",
    icon: Users,
    ...
    level: "Médio",
    mitigation: [
      "Foco em diferenciação por UX e time-to-value",
      "Construção de moats via integrações profundas",
      "Roadmap ágil para resposta rápida ao mercado",
    ],
    responsible: "CEO / CPO",
  },
];
    ...
    >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {risks.map((risk) => (
              <tr key={risk.id} className="border-b transition-colors hover:bg-muted/30">
